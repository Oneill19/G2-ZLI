...
public class ReportQuery {
	 ...
	 */
	public static ReturnCommand getReport(Connection con, String reportNme, String reportMonth,String reportYear ,String storeName)
	{
		Statement stmt;
		String sqlQuery = "SELECT * From zli.reports WHERE storeName='" + storeName + "' AND reportMonth='" + reportMonth + "' AND reportYear='" + reportYear + "' ;";
		
		ResultSet rs = null;
		String report= reportNme + " Report dated " + reportMonth + "-" +reportYear +" for ZER-LI " + storeName + " store " +"\n";
