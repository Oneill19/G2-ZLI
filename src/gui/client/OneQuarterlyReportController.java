 ...
 *
 */
public class OneQuarterlyReportController {
...
float i1=0, i2=0, i3=0, i4=0, i5=0, i6=0, i7=0, i8=0, i9=0, i10=0, i11=0, i12=0;
		...
		for (Report report : ChatClient.reportsq1) {
		...
		reportChart.setTitle("Revenue Quarterly Histogram for store: " + storeName);
		// add data to chart
		reportChart.getData().clear();
		reportChart.getData().add(dataSeries);
		reportChart.getData().add(productRevenue);
		reportChart.getData().add(ItemRevenue);
	}
}
